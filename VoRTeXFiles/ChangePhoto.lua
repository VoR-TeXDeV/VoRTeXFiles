...
if result.id_ then 
local abbs = DevAbs:get("VoRTeXTEAM:Photo"..result.id_)
if not result.profile_photo_ then 
if abbs then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
DevAbs:del("VoRTeXTEAM:Photo"..result.id_) 
end
end
...
DevAbs:set("VoRTeXTEAM:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
