...
if DevAbs:get(VoRTeX.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(VoRTeX.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(VoRTeX.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(VoRTeX.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(VoRTeX.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(VoRTeX.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
VoRTeXName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if VoRTeXName then 
VoRTeXNames = DevAbs:smembers(VoRTeX.."Abs:Mute:Names"..msg.chat_id_) or ""
if VoRTeXNames and VoRTeXNames[1] then 
for i=1,#VoRTeXNames do 
if VoRTeXName:match("(.*)("..VoRTeXNames[i]..")(.*)") then 
...
DevAbs:set(VoRTeX.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(VoRTeX.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
